    ...
    <div id="wrapper">
      <div id="container">
        <section class="open-book">
          <header>
            <h1>Book {{showBook.id}}</h1>
            <h6>Erin E. Sullivan</h6>
          </header>
          <article>
            <h2 class="chapter-title">{{ showBook.title }}</h2>
            <p>
...
export default {
  ...
  created() {
    this.$store
      .dispatch("BookItem", { id: this.$route.params.id })
      .then((resp) => {
        this.showBook = resp.data;
      });
  },
};
</script>
